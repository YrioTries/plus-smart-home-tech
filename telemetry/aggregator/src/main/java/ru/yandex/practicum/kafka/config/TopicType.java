...
public enum TopicType {
    ...
    TELEMETRY_SNAPSHOTS_V1(KafkaTopics.topicList.get(2));;
    ...
    private static class KafkaTopics {
        public static final List<String> topicList = List.of("telemetry.sensors.v1", "telemetry.hubs.v1", "telemetry.snapshots.v1");
    }
}